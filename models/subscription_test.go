...
var (
	subscriptionDBTypes = map[string]string{`ID`: `INTEGER`, `ChannelID`: `TEXT`, `ThreadID`: `INTEGER`, `Regex`: `TEXT`, `RegexBan`: `TEXT`, `ExpiredAt`: `TIMESTAMP`, `CreatedAt`: `TIMESTAMP`, `UpdatedAt`: `TIMESTAMP`, `ChannelTitle`: `TEXT`}
	_                   = bytes.MinRead
)
